...
const variants = {
  ...
  secondary: 'bg-navy-600 text-white hover:bg-navy-700 shadow-md hover:shadow-lg',
...
export default function Button({
  ...
  return (
    <button
      className={cn(
        'font-bold transition-all duration-200 hover:-translate-y-0.5 active:translate-y-0',
